    ...
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
          ...
          <div className='relative flex flex-col gap-3'>
            ...
            <div className='flex items-center flex-wrap gap-4 mt-4'>
              ...
              <button className='bg-pray-700 p-2.5 rounded-full transition
              cursor-pointer active:scale-95'>
          ...
          <div className='flex items-center gap-4 max px-4'>
              {show.movie.casts.slice(0,11).map((cast,index)=>(
                <div key={index} className='flex flex-col items-center text-center'>
                  ...
                  <p className='font-medium texgt-xs mt-3'>{cast.name}</p>
                </div>
              ))}
          </div>
      </div>
      ...
      <div className='flex flex-wrap max-sm:justify-center gap-8'>
       ...
       <div className='flex justify-center mt-20'>
          <button onClick={() => {navigate('/movies'); scrollTo(0,0)}} className='px-20 py-3 text-sm bg-primary hover:bg-primary-dull
          transition rounded-md font font-medium cursor-pointer'>Show more</button>
      </div>   
