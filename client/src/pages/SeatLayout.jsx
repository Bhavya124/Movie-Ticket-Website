...
import { ArrowRight, ArrowRightIcon, Clock, ClockIcon } from 'lucide-react'
...
const SeatLayout = () => {
  ...
  return show ?  (
    ...
    md:pt-50'>
      ...
      <div className='w-60 bg-primary/10 border border/20 rounded/20 rounded-lg py-10
    ...
    <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>
      ...
      <button onClick={() => navigate('/my-bookings')} className='fkex items-center gap-1 mt-20 px-11
